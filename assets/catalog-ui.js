(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260731-absolute-dates-v33",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260731-absolute-dates-v33",10000);
    applyInitialFilters();
