(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260803-instant-bogo-v39",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260803-instant-bogo-v39",10000);
    applyInitialFilters();
