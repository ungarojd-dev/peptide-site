(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260903-eo-api-v2-v100",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260903-eo-api-v2-v100",10000);
    applyInitialFilters();
