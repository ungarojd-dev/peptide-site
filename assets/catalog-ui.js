(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260826-vendors19-v78",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260826-vendors19-v78",10000);
    applyInitialFilters();
