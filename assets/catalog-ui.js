(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260918-eom-push-v167",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260918-eom-push-v167",10000);
    applyInitialFilters();
