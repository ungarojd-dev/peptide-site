(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260925-weekend-sales-v178",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260925-weekend-sales-v178",10000);
    applyInitialFilters();
