(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260730-cms-vendor-sync-v28",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260730-cms-vendor-sync-v28",10000);
    applyInitialFilters();
