(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260909-retire-stale-v137",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260909-retire-stale-v137",10000);
    applyInitialFilters();
