(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260910-popup-per-session-v145",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260910-popup-per-session-v145",10000);
    applyInitialFilters();
