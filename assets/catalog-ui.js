(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260809-deal-corrections-v47",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260809-deal-corrections-v47",10000);
    applyInitialFilters();
