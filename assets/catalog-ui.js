(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260911-labsourced-boost-v151",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260911-labsourced-boost-v151",10000);
    applyInitialFilters();
