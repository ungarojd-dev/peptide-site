(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260725-orbitrex-v2",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260725-orbitrex-v2",10000);
    applyInitialFilters();
