(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260805-august-sales-v45",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260805-august-sales-v45",10000);
    applyInitialFilters();
