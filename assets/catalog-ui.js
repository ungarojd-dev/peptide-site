(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260901-labor-day-v89",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260901-labor-day-v89",10000);
    applyInitialFilters();
