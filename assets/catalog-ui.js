(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260918-glacier-milehigh-v168",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260918-glacier-milehigh-v168",10000);
    applyInitialFilters();
