(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260911-meta-pixel-swap-v149",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260911-meta-pixel-swap-v149",10000);
    applyInitialFilters();
