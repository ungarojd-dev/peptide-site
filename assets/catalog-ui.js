(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260922-honest-dates-v176",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260922-honest-dates-v176",10000);
    applyInitialFilters();
