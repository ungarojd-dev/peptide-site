(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260920-milehigh-30-v172",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260920-milehigh-30-v172",10000);
    applyInitialFilters();
