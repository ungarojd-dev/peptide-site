(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260723-vendor-payments-v1",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260723-vendor-payments-v1",10000);
    applyInitialFilters();
