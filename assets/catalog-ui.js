(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260911-ion-weekend-v152",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260911-ion-weekend-v152",10000);
    applyInitialFilters();
