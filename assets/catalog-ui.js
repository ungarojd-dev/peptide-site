(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260911-weekend-deals-v150",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260911-weekend-deals-v150",10000);
    applyInitialFilters();
