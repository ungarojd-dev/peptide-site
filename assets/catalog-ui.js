(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260831-zenith-alias-v86",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260831-zenith-alias-v86",10000);
    applyInitialFilters();
