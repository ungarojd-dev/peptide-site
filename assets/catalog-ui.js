(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260825-aurora-code20-v77",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260825-aurora-code20-v77",10000);
    applyInitialFilters();
