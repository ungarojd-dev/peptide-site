(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260919-aurora-boost-30-v171",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260919-aurora-boost-30-v171",10000);
    applyInitialFilters();
