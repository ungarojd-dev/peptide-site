(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260910-kit-logo-ticker-v146",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260910-kit-logo-ticker-v146",10000);
    applyInitialFilters();
