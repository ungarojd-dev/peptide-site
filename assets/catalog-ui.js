(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260903-signup-restyle-v93",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260903-signup-restyle-v93",10000);
    applyInitialFilters();
