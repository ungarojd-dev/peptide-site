(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260901-labor-day-v88",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260901-labor-day-v88",10000);
    applyInitialFilters();
