(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260920-hightide-40-v173",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260920-hightide-40-v173",10000);
    applyInitialFilters();
