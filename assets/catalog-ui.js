(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=glacier-discount-20260612a",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=glacier-discount-20260612a",10000);
