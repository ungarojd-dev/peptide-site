(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260803-rules-link-v38",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260803-rules-link-v38",10000);
    applyInitialFilters();
