(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260918-labsourced-50-v169",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260918-labsourced-50-v169",10000);
    applyInitialFilters();
