(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260922-hub-refresh-v177",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260922-hub-refresh-v177",10000);
    applyInitialFilters();
