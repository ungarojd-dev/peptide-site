(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260915-instant-boost-v155",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260915-instant-boost-v155",10000);
    applyInitialFilters();
