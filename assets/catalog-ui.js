(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260830-coffee-flash-v84",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260830-coffee-flash-v84",10000);
    applyInitialFilters();
