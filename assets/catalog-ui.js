(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260909-autumn-popup-v139",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260909-autumn-popup-v139",10000);
    applyInitialFilters();
