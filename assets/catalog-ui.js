(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260831-ion-aurora-v85",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260831-ion-aurora-v85",10000);
    applyInitialFilters();
