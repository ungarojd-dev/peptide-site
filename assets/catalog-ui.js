(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260820-peptira-v64",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260820-peptira-v64",10000);
    applyInitialFilters();
