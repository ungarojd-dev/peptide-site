(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260805-logo-rebundle-v43",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260805-logo-rebundle-v43",10000);
    applyInitialFilters();
