(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260902-labor-day-v91",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260902-labor-day-v91",10000);
    applyInitialFilters();
