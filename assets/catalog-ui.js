(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260904-high-tide-v118",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260904-high-tide-v118",10000);
    applyInitialFilters();
