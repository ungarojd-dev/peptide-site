(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260822-popup-cooldown-v76",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260822-popup-cooldown-v76",10000);
    applyInitialFilters();
