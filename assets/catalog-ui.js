(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260730-announce-bar-fix-v30",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260730-announce-bar-fix-v30",10000);
    applyInitialFilters();
