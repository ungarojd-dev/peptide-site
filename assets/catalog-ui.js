(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260830-zenith-timeout-v83",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260830-zenith-timeout-v83",10000);
    applyInitialFilters();
