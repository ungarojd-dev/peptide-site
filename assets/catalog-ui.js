(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260921-signup-paused-v174",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260921-signup-paused-v174",10000);
    applyInitialFilters();
