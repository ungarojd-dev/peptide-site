(function(global){
  ...
  async function boot(){
    ...
    const fallbackPromise=json("/data/catalog-fallback-snapshot.json?v=20260827-oneday-labor-v81",7000);
    const latestPromise=json("/.netlify/functions/catalog-snapshot?v=20260827-oneday-labor-v81",10000);
    applyInitialFilters();
