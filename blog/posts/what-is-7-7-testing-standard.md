...
1. **Net Purity** — Is the compound actually pure? What percentage is active ingredient?
2. **Net Content** — Does the vial contain the amount advertised (in mg)?
3. **Heavy Metals** — Are there dangerous trace metals like lead or arsenic present?
4. **Endotoxins** — Are bacterial toxins present that could cause adverse reactions?
5. **Identification** — Is the compound actually what it claims to be?
6. **Sterility** — Is the product free from microbial contamination?
7. **Conformity** — Does the product match its certificate of analysis (CoA)?
