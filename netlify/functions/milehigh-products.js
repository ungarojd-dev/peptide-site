...
const COMPANY       = "Mile High Peptides";
const AFFILIATE_URL = "https://milehighcompounds.is/?ref=SAMMYC";
const PER_PAGE      = 100;
...
function mapCategory(wcCategories) {
  ...
  if (/glp|semaglutide|tirzepatide|retatrutide|cagrilintide|cagri|mazdutide|orforglipron|survodutide|liraglutide|amycretin|weight|gla-[123]|ion-[123][str]|pep-(?:sm|tz|trz|rt)|tesofensine|metaboflex|mhc-2/.test(t)) return "GLP-1 & Incretin";
